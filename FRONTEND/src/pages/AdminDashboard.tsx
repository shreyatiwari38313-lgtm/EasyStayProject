...
//   // ✅ ROUTE PROTECTION (fixed properly)
//   useEffect(() => {
//     const userData = localStorage.getItem("user");
...
//     { id: "1", title: "House 1", city: "Delhi", price: 1000, status: "pending" },
//     { id: "2", title: "House 2", city: "Mumbai", price: 2000, status: "approved" }
//   ];

//   const bookings: Booking[] = [
//     { id: "1", user: "User 1", property: "House 1", from: "2026-01-01", to: "2026-01-05", status: "confirmed" }
//   ];

//   const reviews: Review[] = [
//     { id: "1", user: "User 1", property: "House 1", rating: 5, comment: "Great!" }
//   ];
...
//           <div className="bg-white p-4 shadow rounded">
//             <p>Properties</p>
//             <h2 className="text-xl font-bold">{totals.properties}</h2>
//           </div>
//           <div className="bg-white p-4 shadow rounded">
//             <p>Bookings</p>
//             <h2 className="text-xl font-bold">{totals.bookings}</h2>
//           </div>
//         </div>
