...
const Properties = () => {
  ...
  // ✅ Initially only dummy data
  const [allProperties, setAllProperties] = useState<any[]>(properties);
  ...
  try {
    ...
    console.log("Backend properties:", data); // ✅ DEBUG

    if (!data || data.length === 0) {
      console.log("No backend properties found");
      return;
    }
    ...
    console.error("Error loading backend properties:", error);
  }
};
  ...
  const filteredAndSortedProperties = useMemo(() => {
    ...
    return filtered;
  }, [allProperties, searchTerm, propertyType, priceRange, guests, sortBy]);
          ...
          <div className="lg:col-span-3">
            ...
            <div className="mt-12 flex justify-center">
              <Button
                ...
                disabled={loadedBackend}
              >
                {loadedBackend ? "All Properties Loaded" : "Load More Properties"}
              </Button>
            </div>
          </div>
        </div>
...
//   // ✅ Combined properties (dummy + backend)
//   const [allProperties, setAllProperties] = useState<any[]>([]);

//   // 🔥 ✅ FETCH BACKEND + MERGE WITH DUMMY
//   useEffect(() => {
...
//         setAllProperties([...properties, ...formatted]);
//       } catch (error) {
//         console.error("Backend failed, using dummy data");
